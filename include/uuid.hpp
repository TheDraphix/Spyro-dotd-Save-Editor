...
namespace uuid // all UUID's are in little endian 
{
	...
	namespace spawn
	{
		...
		constexpr int number_of_locations[NUMBER_OF_CHAPTERS] = {1, 11, 3, 13, 11, 8, 20, 12, 14, 8, 4, 3};

		const UUID no_name[ number_of_locations[NO_NAME] ] = {0x679df416, 0x70262341, 0xac926ce3, 0x8bf277eb};
		const UUID the_catacombs[ number_of_locations[THE_CATACOMBS] ] = {
		...
		const UUID twilight_falls[ number_of_locations[TWILIGHT_FALLS] ] = {
		...
		const UUID valley_of_avalar[ number_of_locations[VALLEY_OF_AVALAR] ] = {
		...
		const UUID dragon_city[ number_of_locations[DRAGON_CITY] ] = {
		...
		const UUID attack_of_the_golem[ number_of_locations[ATTACK_OF_THE_GOLEM] ] = {
		...
		const UUID ruins_of_warfang[ number_of_locations[RUINS_OF_WARFANG] ] = {
		...
		const UUID the_dam[ number_of_locations[THE_DAM] ] = {
		...
		const UUID the_destroyer[ number_of_locations[THE_DESTROYER] ] = {
		...
		const UUID burned_lands[ number_of_locations[BURNED_LANDS] ] = {
		...
		const UUID floating_islands[ number_of_locations[FLOATING_ISLANDS] ] = {
		...
		const UUID malefors_lair[ number_of_locations[MALEFORS_LAIR] ] = {
		...
		const UUID * const spawn_point[NUMBER_OF_CHAPTERS] =
		{ // SYNTAX: spawn_point[CHAPTER][LOCATION][4-BYTE-CHUNK INDEX]
			no_name,
			the_catacombs,
			twilight_falls,
			valley_of_avalar,
		...
		std::tuple<Chapter,int> MatchUUID(UUID id);
	}
